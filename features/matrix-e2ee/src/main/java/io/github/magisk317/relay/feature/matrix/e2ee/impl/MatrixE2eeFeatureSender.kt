package io.github.magisk317.relay.feature.matrix.e2ee.impl

import android.content.Context
import io.github.magisk317.relay.engine.model.MsgInfo
import io.github.magisk317.relay.sender.MatrixE2eeSender
import io.github.magisk317.relay.sender.MatrixUtils
...
object MatrixE2eeFeatureSender : MatrixE2eeSender {
     ...
     *
     * Routing logic:
     * 1. Check E2EE availability via [PlayFeatureAvailability] → if unavailable, delegate to plaintext
    ...
    override suspend fun sendMsg(context: Context, setting: MatrixSetting, msgInfo: MsgInfo) {
        ...
        SLog.d(TAG, "Play E2EE dynamic module is available, evaluating room encryption")
