...
/**
 * Expressive/Material chrome for the app-notify sender binding screen of the
 * same name: static top bar with a material3 `TextButton` save action; the
 * glass top bar samples the page content recorded by the inner `Box`.
 */
@Composable
internal fun AppNotifySenderBindingScreenMaterial(
    title: String,
    onBack: () -> Unit,
    onSave: () -> Unit,
    saveLabel: String,
