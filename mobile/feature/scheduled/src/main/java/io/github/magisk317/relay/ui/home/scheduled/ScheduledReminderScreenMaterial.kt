...
/**
 * Expressive/Material chrome for the scheduled-reminder settings
 ...
 * inner `Box`. The settings dialog tail stays at entry level.
 */
@Composable
internal fun ScheduledReminderScreenMaterial(
    title: String,
    onBack: () -> Unit,
