...
/**
 * Miuix chrome for the verification-settings screen of the same
 * name: static top bar hosted in a page-owned miuix `Scaffold`
 * with horizontal-only content window insets; the dismissible
 * snackbar host stays on the scaffold slot. The five settings
 * dialogs stay at entry level.
 */
@Composable
internal fun VerificationSettingsScreenMiuix(
    title: String,
    onBack: () -> Unit,
