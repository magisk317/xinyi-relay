...
/**
 * Expressive/Material chrome for the verification-settings screen
 * of the same name: static top bar hosted in a page-owned
 ...
 * inner `Box`. The five settings dialogs stay at entry level.
 */
@Composable
internal fun VerificationSettingsScreenMaterial(
    title: String,
    onBack: () -> Unit,
