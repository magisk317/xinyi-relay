 ...
 * same name: static top bar hosted in a page-owned miuix `Scaffold`
 * with horizontal-only content window insets; the dismissible
 * snackbar host stays on the scaffold slot. The rule-editor dialog
 * tail stays at entry level.
 */
@Composable
