...
/**
 * Miuix chrome for the sender-type picker of the same name: static
 * top bar hosted in a page-owned miuix `Scaffold` with horizontal-only
 * content window insets; the glass top bar samples the page content
 * recorded by the inner `Box`.
 */
@Composable
internal fun SenderTypeScreenMiuix(
    title: String,
    onBack: () -> Unit,
