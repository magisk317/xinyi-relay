...
class SmsDispatchIntentHandlerTest {
    ...
    private fun noMatch(): io.github.magisk317.relay.common.utils.SmsBlacklistUtils.MatchResult {
        return io.github.magisk317.relay.common.utils.SmsBlacklistUtils.MatchResult(matched = false)
    }
