...
--
-- This baseline intentionally uses CREATE TABLE/INDEX IF NOT EXISTS so it can be
-- recorded as applied on databases that were already provisioned by the previous
-- startup-time DDL, without failing on existing objects. New migrations (0002+)
-- should NOT rely on IF NOT EXISTS and must express forward changes explicitly
