...
object RelayPrefConst {
    ...
    const val KEY_ENABLE_SMS_BLACKLIST_HIT_RECORDS = "pref_enable_sms_blacklist_hit_records"
    const val KEY_HISTORY_LIMIT_SMS_BLACKLIST_HIT = "pref_history_limit_sms_blacklist_hit"
    const val SMS_BLACKLIST_HIT_HISTORY_LIMIT_DEFAULT = "200"
    ...
    const val KEY_FORWARD_SILENT_PERIOD_ENABLED = "pref_forward_silent_period_enabled"
    const val KEY_FORWARD_SILENT_PERIOD_START = "pref_forward_silent_period_start"
    const val KEY_FORWARD_SILENT_PERIOD_END = "pref_forward_silent_period_end"
    const val KEY_FORWARD_SILENT_PERIOD_WEEKDAYS = "pref_forward_silent_period_weekdays"
